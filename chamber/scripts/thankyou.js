...
function getQueryParams() {
    ...
    return {
        ...
        organization: params.get("organization") || "Not provided",
        description: params.get("organization-description") || "Not provided",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("submitted-organization").textContent = data.organization;
    document.getElementById("submitted-description").textContent = data.description;
